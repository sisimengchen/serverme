...
type User struct {
	ID        string     `gorm:"type:varchar(100);primary_key;unique_index" json:"id"`
...
type UserRole struct {
	ID        string     `gorm:"column:id;primary_key;auto_increment;" json:"-"`
	UserID    string     `gorm:"type:varchar(100);not null;" json:"-"`      // 用户内码
	RoleID    string     `gorm:"type:varchar(100);not null;" json:"roleID"` // 角色内码
